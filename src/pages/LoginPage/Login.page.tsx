...
const Loginpage = (props: Props) => {
  ...
  NativeModules.HelloWorldModule.getCustomName((val: any) => {
    setNativeAndroidText(val);
  });
  const onLogin = () => {
    ...
    <BottomSheetModalProvider>
      <View
        style={[
          ...
          {backgroundColor: choosedTheme == 'dark' ? '#333333' : '#ffffff'},
        ]}>
        ...
        <BottomSheetModal
          ...
          <View
            style={[
              ...
              {backgroundColor: choosedTheme == 'dark' ? '#333333' : '#EDEADE'},
            ]}>
            <Text
              style={loginStyles.modalText}
              onPress={() => changeTheme('systemDefault')}>
              SYSTEM DEFAULT
            </Text>
            <Text
              style={loginStyles.modalText}
